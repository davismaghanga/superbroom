...
var render = function() {
  ...
  return _c("form", { attrs: { action: "", method: "post" } }, [
    _vm.errors.length
      ? _c("div", [
          _c("span", [_vm._v("Please correct the following errors:")]),
          _vm._v(" "),
          _c(
            "ul",
    ...
    _c("div", [
      _c("input", {
        ...
        staticClass:
          "border rounded-md py-3 px-3 mb-4 text-black placeholder-black w-full",
        attrs: { type: "text", name: "full_name", placeholder: "Full Name*" },
    ...
    _c(
      ...
      {
        staticClass:
          "flex flex-no-wrap items-center justify-between text-white mt-12 rounded mb-24 cursor-pointer",
        staticStyle: { "background-color": "#ED272B" },
        on: {
      ...
      [
        _c("div", { staticClass: "text-left pl-6 py-3" }, [_vm._v("SEND")]),
        _vm._v(" "),
        _c("div", { staticClass: "pr-6 py-3" }, [_vm._v("→")])
      ]
    )
  ])
}
  ...
  methods: {
    sendMessage: function sendMessage() {
      if (this.fullName && this.email_address && this.message) {
        ...
        console.log(this.formData); //send formdata to server
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\superbroom\resources\sass\app.scss */"./resources/sass/app.scss");
